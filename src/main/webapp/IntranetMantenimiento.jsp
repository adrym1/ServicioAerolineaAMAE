    ...
    <main class="dark">
     ...
     <div class="grid-container">
        ...
        <div class="grid-item  wide " style="background-image: url(img/icono\ principal.png);">
            <a href="IntranetPrincipal.jsp" style="text-decoration:none ;"><p>MENÚ PRINCIPAL</p></a>

            <!-- <h1>Cerrar Sesión </h1>-->
        </div>

         <div class="grid-item  wide tall" style="background-image: url(img/icono\ usuario.png);" > 
            
          <a href="verUsuario" style="text-decoration: none;">  
          <p>USUARIO</p>
     </a>
          <!--<h1>Configurar cuenta de usuario</h4>-->
        
        </div>
    
          
         <div class="grid-item  wide " style="background-image: url(img/icono\ cliente.png);">
          <a href="MantenimientoCliente.jsp" style="text-decoration: none;">  
          <p>CLIENTE</p>
     </a>
          <!--  <h1>Cliente - Vuelos - Promociones <br> Proveedores</h1>-->
        </div>
 
         <div class="grid-item  wide " style="background-image: url(img/icono\ proveedor.png);">
              <a href="MantenimientoProveedor.jsp" style="text-decoration: none;">  
          <p>PROVEEDOR</p>
     </a>
             <!--<h1>Clientes - Vuelos - Destinos más visitados</h1>-->
        </div>

         <div class="grid-item  wide " style="background-image: url(img/icono\ vuelos.png);"> 
            <a href="MantenimientoVuelo.jsp" style="text-decoration: none;">  
          <p>VUELOS</p>
     </a>
         ...
         <div class="grid-item  wide "  style="background-image: url(img/icono\ promocion.png);">
                <a href="MantenimientoPromocion.jsp " style="text-decoration: none;" >  
          <p>PROMOCION</p>
     </a>
