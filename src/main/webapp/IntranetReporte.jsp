    ...
    <main class="dark">
        ...
        <div class="grid-container">
            ...
            <div class="grid-item  wide " style="background-image: url(img/icono\ principal.png);">
                <a href="IntranetPrincipal.jsp" style="text-decoration:none ;">
                    <p>MENÚ PRINCIPAL</p>
                </a>
             ...
             <div class="grid-item  wide tall" style="background-image: url(img/icono\ reportevuelo.png);" > 
                <a href="verVuelos">
                <p>REPORTE VUELO</p>
                </a>
             ...
             <div class="grid-item  wide " style="background-image: url(img/icono\ de\ reporte\ de\ destinos.png);">
             <a href="verDestinos">
             <p>REPORTE DE DESTINOS </p>
             </a>
                
    
              <!--  <h1>Cliente - Vuelos - Promociones <br> Proveedores</h1>-->
            </div>
      		<div class="grid-item  wide " style="background-image: url(img/Icono_reporte.png);">
             <a href="verCliente">
