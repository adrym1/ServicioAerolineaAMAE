						...
						<div class="contenedor">
							...
							<div class="form-row" style="margin-top: 50px">
								<div class="form-group col-md-4">
									<label for="tex">Código (cambiar*) </label> <input type="text"
								...
								<div class="form-group col-md-2">
									<button type="button" class="btn btn-primary"
										...
										data-whatever="@mdo" name="btnAccion"
										value="listarPromocionInactiva"
							...
							<div class="botones" style="margin-top: 70px;">
								...
								<button type="input" class="btn btn-registrar" name="btnAccion"
									value="actualizarActivar">
				...
				<div class="modal fade" id="exampleModal" tabindex="-1"
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content"
							style="width: 1050px; background: white; margin-left: 60px;">
							...
							<div class="modal-body">
								...
								<table class="table table-dark">
									...
									<tbody>
										...
										%>
										<tr>
											<td style="width: 5%;"><%=pr.getCod_promocion()%></td>
